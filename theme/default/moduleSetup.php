...
<?php foreach ($modules as $module) {
    if ($module['status'] == true && $module['key'] != '') {
        echo '<pre style="height:55px;"><button style="float:left;" type="button" class="btn btn-primary">' . $module['name'] . '</button> <div style="float:right;"><a href="/modules.php?module=' . $module['key'] . '">Configure</a></div><br/></pre><br/>';
    }
} ?>
