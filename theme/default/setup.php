...
<div id="start">
<div class="jumbotron">
  <h1 style="border-bottom:solid 1px #999;padding-bottom:10px;margin-top:0px;margin-bottom:20px;">Setup Process!</h1>
  <p>This is the start of the setup process, press the button below to start the setup.</p>
  <p>Here is a quick run down of what you will need to fully setup this device. If you do <b>not</b> understand or have any of the details below, please do not continue.</p>
...
<div id="step1">
<div class="jumbotron">
<h1 style="border-bottom:solid 1px #999;padding-bottom:10px;margin-top:0px;margin-bottom:20px;">Step 1</h1>
...
<div class="jumbotron">
<h1 style="border-bottom:solid 1px #999;padding-bottom:10px;margin-top:0px;margin-bottom:20px;">Step 2</h1>
...
<div class="jumbotron">
<h1 style="border-bottom:solid 1px #999;padding-bottom:10px;margin-top:0px;margin-bottom:20px;">Setup Finalize</h1>
