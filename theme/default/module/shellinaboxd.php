...
<div style="margin:auto;width:315px;text-align:center;">
    ...
    <br/><br/>
    <a target="_blank" id="trans">
        <pre><b>Start a shell window</b></pre>
    </a>
    <img src="http://www.turnkeylinux.org/files/images/screenshots/webshell.jpg?1295873230" width="315px"
         height="215px"/>
</div>
<script>
